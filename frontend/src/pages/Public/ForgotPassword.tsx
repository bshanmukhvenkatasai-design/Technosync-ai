    ...
    <div className="min-h-screen bg-[#F7F9F8] flex items-center justify-center p-6 relative overflow-hidden font-inter">
      ...
      <div className="w-full max-w-md bg-white border border-[#DCE5E2] rounded-3xl p-8 shadow-xl relative z-10 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-extrabold text-[#1F2937] font-poppins">Forgot password</h2>
          <p className="text-sm text-gray-500">Reset your sovereign dashboard access credentials</p>
        </div>
        ...
        {success ? (
          <div className="text-center py-6 space-y-4">
            ...
            <h3 className="text-lg font-bold text-gray-800 font-poppins">Recovery Email Sent</h3>
            <p className="text-sm text-gray-500">We have dispatched a password reset link to your email address.</p>
            <Link 
              to="/login"
        ...
        <div className="text-center pt-2 border-t border-gray-100">
          <Link to="/login" className="inline-flex items-center text-xs font-semibold text-[#2F5D62] hover:underline space-x-1">
